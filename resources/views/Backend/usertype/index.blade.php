...
<div class="container-fluid container-fullw bg-white">
 ...
 @foreach($userstype as $row)
            ...
            <div class="visible-md visible-lg hidden-sm hidden-xs">
              <a href="{{route('typs.edit',['id'=>$row->id])}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
              <form action="{{route('typs.delete',['id'=>$row->id])}}" method="get">
              {{ csrf_field() }}
